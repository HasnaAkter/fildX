...
const Services = () => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 justify-center md:p-8 lg:p-4 p-5" style={bannerStyle}>
            ...
            <ServiceCard image={trophy} title="300 Days" description="In Operations" />
        </div>
    );
};
