    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 justify-center md:p-8 lg:p-4 p-5 bg-white">
        <div className="md:col-span-1 lg:col-span-1 p-5 lg:p-10">
          ...
          <div className=" ">
            <h1 className="text-lg md:text-2xl lg:text-2xl font-bold">Real-time analytics</h1>
          ...
          <div className="">
            <h1 className="text-lg md:text-2xl lg:text-2xl font-bold">Intuitive dashboard</h1>
            <p className="text-sm md:text-base lg:text-base">
              See product usage, sign-ins, feature metrics change as users work on your.
            </p>
          </div>
          ...
          <div className="">
            <h1 className="text-lg md:text-2xl lg:text-2xl font-bold">Smart suggestions</h1>
            <p className="text-sm md:text-base lg:text-base">
              See product usage, sign-ins, feature metrics change as users work on your.
            </p>
          </div>
        ...
        <div className="lg:col-span-1 rounded-lg p-5 lg:p-10 text-black">
          ...
          <div className="">
            <h1 className="text-lg md:text-2xl lg:text-2xl font-bold">Multiple views</h1>
            <p className="text-sm md:text-base lg:text-base">
              See product usage, sign-ins, feature metrics change as users work on your.
            </p>
          </div>
          ...
          <div className="">
            <h1 className="text-lg md:text-2xl lg:text-2xl font-bold">AI-led diagnoses</h1>
            <p className="text-sm md:text-base lg:text-base">
              See product usage, sign-ins, feature metrics change as users work on your.
            </p>
          </div>
          ...
          <div className="">
            <h1 className="text-lg md:text-2xl lg:text-2xl font-bold">Responsive</h1>
            <p className="text-sm md:text-base lg:text-base">
              See product usage, sign-ins, feature metrics change as users work on your.
            </p>
          </div>
